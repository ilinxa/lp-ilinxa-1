        ...
        <div className='container'>
            ...
            <div className='mt-8 flex flex-wrap gap-3 justify-center'>
                {features.map((feature,i) => (
                    <div key={i} className='bg-neutral-900 border border-white/10 inline-flex px-3 md:px-5 md:py-2 py-1.5 rounded-2xl justify-center items-center gap-3'>

                        <span className='bg-lime-400 text-neutral-900 size-5 rounded-full inline-flex justify-center items-center '> &#10038;</span>
